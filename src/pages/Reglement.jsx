  ...
  return (
    ...
    { role:'Administrateur', nom:'Gérald DURAND-DESGRANGES' },
      ...
      <Section num="3" title="Bonus">
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:10 }}>
          {[
            ...
            { ico:'2️⃣', title:'Double Chance', qty:'×4 / saison', color:'var(--p)', dim:'var(--p-dim)', b:'var(--p-b)', desc:"Joue 2 résultats sur 1 match (1/N, 1/2 ou N/2). Si l'un est bon → 1 pt, ou 2 pts si cette issue est une surprise. Non utilisable sur le match à scorer." },
          ].map(b => (
      ...
      <Section num="4" title="Déroulement d'une journée">
        ...
        <Li>Après la deadline → pronos révélés à tous les chatteux</Li>
